...
public class ZipExtractor extends Activity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    mInput = new File(getIntent().getStringExtra(InterpreterConstants.EXTRA_INPUT_PATH));
    mOutput = new File(getIntent().getStringExtra(InterpreterConstants.EXTRA_OUTPUT_PATH));
    if (!mOutput.exists()) {
      if (!mOutput.mkdirs()) {
