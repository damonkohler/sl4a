...
public class AlarmManagerFacade extends RpcReceiver {
  ...
  public AlarmManagerFacade(FacadeManager manager) {
    ...
    TriggerRepository triggerRepository = manager.getTriggerRepository();
  ...
  public void scheduleRepeating(
      @RpcParameter(name = "interval", description = "interval between invocations, in seconds") Double interval,
      @RpcParameter(name = "script", description = "script to execute") String script,
      @RpcParameter(name = "firstExecutionTime", description = "first time to execute script, in seconds since epoch") @RpcOptional Double firstExecutionTime,
