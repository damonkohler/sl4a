...
//  }
//  
//  @Rpc(description = "Records an audio snippet over a fixed amount of time.",
//      params = "String targetPath, String title, int lengthMs")
//  public JSONObject recordAudio(JSONArray params) {
...
//    try {
//      targetPath = params.getString(0);
//    } catch (JSONException e) {
//      return JsonRpcResult.error("Invalid target path (parameter 1).", e);
//    }
//
//    try {
//      title = params.getString(1);
//    } catch (JSONException e) {
//      return JsonRpcResult.error("Invalid title (parameter 2).", e);
//    }
//
//    try {
//      lengthMs = params.getInt(2);
//    } catch (JSONException e) {
//      return JsonRpcResult.error("Invalid length (parameter 3).", e);
//    }
//
//    // Make the call.
//    try {
//      mAndroidFacade.recordAudio(targetPath, title, lengthMs);
//    } catch (IOException e) {
//      return JsonRpcResult.error("IOException", e);
//    } catch (InterruptedException e) {
//      return JsonRpcResult.error("InterruptedException", e);
//    }
//
//    return JsonRpcResult.empty();
//  }
