...
public final class BluetoothMap implements BluetoothProfile {
    ...
    public boolean setPriority(BluetoothDevice device, int priority) {
        ...
        if (mService != null && isEnabled() &&
            isValidDevice(device)) {
            if (priority != BluetoothNonpublicApi.PRIORITY_OFF &&
                priority != BluetoothNonpublicApi.PRIORITY_ON) {
              return false;
            }
            try {
    ...
    public int getPriority(BluetoothDevice device) {
        ...
        if (mService != null && isEnabled() &&
            ...
            try {
                ...
                Log.e(TAG, Log.getStackTraceString(new Throwable()));
                return BluetoothNonpublicApi.PRIORITY_OFF;
            }
        }
        if (mService == null) Log.w(TAG, "Proxy not attached to service");
        return BluetoothNonpublicApi.PRIORITY_OFF;
    ...
    private final ServiceConnection mConnection = new ServiceConnection() {
        public void onServiceConnected(ComponentName className, IBinder service) {
            ...
            if (mServiceListener != null) {
                mServiceListener.onServiceConnected(BluetoothNonpublicApi.MAP, BluetoothMap.this);
            }
        }
        public void onServiceDisconnected(ComponentName className) {
            ...
            mService = null;
            if (mServiceListener != null) {
                mServiceListener.onServiceDisconnected(BluetoothNonpublicApi.MAP);
            }
        }
    };
